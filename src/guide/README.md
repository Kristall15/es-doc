...
Список персонажей и их переменные представлены в таблице по ссылке: [Персонажи](../tables.md#персонажи)
...
Фоны из игры представлены в таблице по ссылке: [Изображения - Фоны](../tables.md#фоны)

### Иллюстрации[ЦГ]

Общий синтаксис для вывода иллюстраций схож с синтаксисом вывода фонов: `scene/show <Название арта>`
Например:
...
Все иллюстрации из представлены в таблице по ссылке: [Изображения - Иллюстрации](../tables.md#арты)
## Спрайты
...
Проигрывайте аудиофайлы на соответствующем аудио-канале.
:::

### Музыка

Для начала проигрывания музыки используется: `play music music_list["<Название>"]`, а для остановки - `stop music`.

Список музыки из игры представлен в таблице по ссылке: [Звуки - Музыка](../tables.md#музыка)
...
Звуки окружения из игры представлены в таблице по ссылке: [Звуки - Окружение](../tables.md#окружение)

### Прочее

`play sound <Название>`

Прочие звуки из игры представлены в таблице по ссылке: [Звуки - Прочие звуки](../tables.md#прочие-звуки)
