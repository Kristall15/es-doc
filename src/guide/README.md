...
Список персонажей и их переменные представлены в таблице по ссылке: [Ресурсы - Персонажи](../resources/#персонажи).
...
Фоны из игры представлены в таблице по ссылке: [Ресурсы - Изображения - Фоны](../resources/#фоны).
...
Все иллюстрации из игры представлены в таблице по ссылке: [Ресурсы - Изображения - Иллюстрации](../resources/#cg)
...
Список музыки из игры представлен в таблице по ссылке: [Ресурсы - Звуки - Музыка](../resources/#музыка)
...
Звуки окружения из игры представлены в таблице по ссылке: [Ресурсы - Звуки - Окружение](../resources/#окружение)

### Прочее

`play sound <Название>`

Прочие звуки из игры представлены в таблице по ссылке: [Ресурсы - Звуки - Прочие звуки](../resources/#прочие-звуки)
...
Самый простой способ отображения видео в полноэкранном режиме заключается в использовании функции `renpy.movie_cutscene`. Она отображает видео в полноэкранном режиме до тех пор, пока он не закончится либо игрок не щелкнет кнопкой мыши, чтобы прекратить воспроизведение.
