...
Он состоит из оператора, объявляющего новый экран (`screen`), операторов, добавляющих отображаемые объекты на этот экран (например, `add` или `imagebutton`), и операторов управления (`xalign`, `yalign`, `spacing`).
